...
struct PipelineManager : private D3D12_GRAPHICS_PIPELINE_STATE_DESC
{
private:
...
public:
	...
	PipelineManager() : D3D12_GRAPHICS_PIPELINE_STATE_DESC() {  }
	...
	// デプスステンシルステート
	void InitDepthStencilState() { DepthStencilState = CD3DX12_DEPTH_STENCIL_DESC(D3D12_DEFAULT); }
	// 深度バッファのフォーマット
	void InitDSVFormat() { DSVFormat = DXGI_FORMAT_D32_FLOAT; }
	void SetDepthWriteMask(D3D12_DEPTH_WRITE_MASK depthWriteMask) { DepthStencilState.DepthWriteMask = depthWriteMask; }
